...
function edit_person(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('#id').val(data['user_info'][0].id);
            $('#name').val(data['user_info'][0].name);
            $('#contact').val(data['user_info'][0].contact);
            $('#address').val(data['user_info'][0].address);
            $('#email').val(data['user_info'][0].email);
            $('#username').val(data['user_info'][0].username);
            $('#password').val(data['user_info'][0].password);
