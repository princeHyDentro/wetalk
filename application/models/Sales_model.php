...
class Sales_model extends CI_Model {
    ...
    var $table          = 'applicant';
    var $column_order   = array('id','name','contact','	address','email	','service','status','username','password'); 
    var $column_search  = array('id','name','contact','address','email','service','status','username','password');
    ...
    public function index(){
        ...
        $this->load->view('registration/sales_form');
    }
