							...
							<div class="section-content">
								...
								<?php 
								    if ($id != "") {
										...
										<form enctype="multipart/form-data" id="update_applicant">
										<?php 
									} else {
								 ?>
								        <form enctype="multipart/form-data" id="create_new_applicant">
									<?php } ?>
								...
								<div class="form-container col-12">
									<div class="col-md-6 form-line">
										<div class="form-group">
											...
											<input type="text" required class="form-control" id="name" placeholder=" Enter Name" value='<?php if($id != "") {echo $client[0]->name;}?>' >
										</div>
										<div class="form-group">
											<label for ="Address"> Address</label>
											<textarea required class="form-control" id="address" placeholder="Enter Your Address"><?php if($id != "") {echo $client[0]->client_address;}?></textarea>
										</div>										
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="email" required class="form-control" id="email_address" placeholder=" Enter Email id" value='<?php if($id != "") {echo $client[0]->client_email;}?>'>
										</div>  
										<div class="form-group">
											<div class="input-group">	
												<span class="label-custom input-group-addon-new">BirthDate</span>
								                <input type='text' required class="form-control datepicker form-control-new" id="birthdate" value='<?php if($id != "") {echo $client[0]->client_birthdate;}?>' />
								                <span class="label-custom input-group-addon-new" for="age">Age</span>
												<input type="text" required class="form-control form-control-new" id="age" placeholder=" Enter age" value='<?php if($id != "") {echo $client[0]->client_age;}?>' 
												   oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');">
							            	</div>
										</div>											
										<div class="form-group">
											...
											?>
											<select class="selectpicker form-control" id="gender" required>
										...
										<div class="form-group">
											...
											<input type="text" required class="form-control" id="year_graduated" placeholder=" Enter year graduated" value='<?php if($id != "") {echo $client[0]->client_yeargraduated;}?>' 
											  oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');">
										</div>
										<div class="form-group">
											<label for="exampleInputEmail">Date Visited</label>
							                <div class='input-group date'>
							                    <input type='text' required class="form-control  datepicker" id='date_visited' value='<?php if($id != "") {echo $client[0]->client_datevisited;}?>'/>
							                </div>
										</div>
										<div class="form-group">
											<label for="School">School</label>
											<input type="text" required class="form-control" id="school" placeholder=" Enter your school name" value='<?php if($id != "") {echo $client[0]->client_school;}?>'>
										</div>	
									</div>
									<!-- right container-->
									<div class="col-md-6">			
										...
										<div class="form-group">
											...
											<input type="text" required class="form-control" id="course" placeholder=" Enter course" value='<?php if($id != "") {echo $client[0]->client_course;}?>'>
										</div>	
										<div class="form-group">
										    <?php
										...
										<div class="form-group">
											<div class="input-group">												
											    ...
											    <select class="selectpicker form-control form-control-new" required id="month">
													<option value="">Select</option>
											    ...
											    <input type="text" required class="form-control form-control-new" id="year" placeholder="End"/ value='<?php if($id != "") {echo $client[0]->client_yearapplied;}?>' 
												  oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');">
											</div>
										</div>
										<div class="form-group">
											<label for="gender">J1 Type</label>
											<select class="selectpicker form-control" required id="j1_type">
												<option value="">Select</option>
										...
										<div class="form-group">
											...
											<textarea  class="form-control" required id="message" placeholder="Enter Your Message"><?php if($id != "") {echo $client[0]->client_remarks;}?></textarea>
										</div>
										<div class="form-group">
											<label for ="form #"> Form #</label>
											<input  class="form-control" required id="formno" placeholder="Enter Form No." value='<?php if($id != "") {echo $client[0]->client_formno;}?>' 
											 oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');">
										</div>	
