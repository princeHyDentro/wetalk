...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/prism.css');?>" type="text/css" media="screen,projection" />
    <link rel="stylesheet" href="<?php echo base_url('assets/css/materialdesignicons.css'); ?>" type="text/css" media="screen,projection" />
    ...
    <header>
        <div class="navbar-fixed">
            <nav class="top-nav teal darken-1">
                <div class="container">
                    <div class="nav-wrapper"> <a href="http://localhost/pmg_hr_new/public" class="page-title"><img src="<?php echo base_url('assets/logo/logo2.png'); ?>" alt="" class="responsive-img valign profile-image-login"></a>
                        ...
                        <ul class="collapsible collapsible-accordion">
                            <li> <a class="collapsible-header padding-32"><i class="material-icons">folder_open</i>Staff<i class="material-icons right">arrow_drop_down</i></a>
                                <div class="collapsible-body">
                                    <ul>
                                        <li><a href="<?php  echo base_url('registration/employee_registration_form'); ?>">Create Staff</a> </li>
                                        <li><a href="#!">View Staff</a> </li>
                                        <li><a href="#!">View Deleted Staff</a> </li>
                                    </ul>
                                </div>
                            </li>
                        </ul>
